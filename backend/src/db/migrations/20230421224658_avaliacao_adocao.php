...
final class AvaliacaoAdocao extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $produto_avalicao = $this->table('avaliacao_adocao', ['id' => 'cod']);
        $produto_avalicao->addColumn('quantidade_stars', 'integer', ['null' => false ])
                         ...
                         ->addColumn('cod_pet_adocao', 'integer', ["signed" => false])

                         ->addForeignKey('cod_user', 'users', 'cod', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
                         ->addForeignKey('cod_pet_adocao', 'pet_adocao', 'cod', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
